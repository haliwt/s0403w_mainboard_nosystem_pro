...
void works_run_two_hours_state(void)
{
   ...
   if(gpro_t.gTimer_check_twohours > 7200){ //two works two hours stop flag is "1"
    ...
    case 1: //don't run main board any action.
	 ...
	 if(gpro_t.gTimer_check_twohours > 120){ //10
      ...
      if( gpro_t.gTimer_check_twohours > 600){ //10 minutes =600s
